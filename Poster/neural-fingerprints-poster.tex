...
\begin{minipage}[c][9cm][c]{0.76\textwidth}
  \begin{center}
    ...
    {\huge\sffamily \Huge Paweł Budzianowski, Thomas F. W. Nicholson,   \\[7.5mm]
...
\mysection{Generic estimator versus default SGVB one}
...
\mysection{Baysian: is it really all that?}
